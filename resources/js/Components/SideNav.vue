<template>
        ...
        <nav class="side-nav">
            ...
            <ul>
                <li>
                    <Link :href="'/admin/categories'" :class="{ 'side-menu--active': $page.url === '/admin/categories'||$page.url === '/admin/create-categories' }" class="side-menu cursor-pointer">
                        <div class="side-menu__icon"> <i data-lucide="inbox"></i> </div>
                        <div class="side-menu__title"> Categories </div>
                    </Link>
                </li>
                <li>
                    <Link :href="'/admin/sub-categories'" :class="{ 'side-menu--active': $page.url === '/admin/sub-categories'||$page.url === '/admin/create-sub-categories' }" class="side-menu cursor-pointer">
                        <div class="side-menu__icon"> <i data-lucide="inbox"></i> </div>
                        <div class="side-menu__title"> Sub categories </div>
                    </Link>
                </li>
                <li>
                    <Link :href="'/admin/epapers'" :class="{ 'side-menu--active': $page.url === '/admin/epapers'||$page.url === '/admin/epapers' }" class="side-menu cursor-pointer">
                        <div class="side-menu__icon"> <i data-lucide="inbox"></i> </div>
